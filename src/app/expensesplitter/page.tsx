...
export default function ExpenseSplitterPage() {
  const [members, setMembers] = useState<string[]>(["Senthil", "Giri", "Parthi", "Viswa", "Mahesh"]);
  ...
  const [draft, setDraft] = useState<DraftExpenseInput>({
    ...
    amount: "",
    paidBy: "Senthil",
    participants: ["Senthil", "Giri", "Parthi", "Viswa", "Mahesh"],
    shareMode: "equal",
    shares: { Senthil: 20, Giri: 20, Parthi: 20, Viswa: 20, Mahesh: 20 },
  });
    ...
    <section className="space-y-6">
      ...
      <div className="rounded-xl border bg-white p-4">
        ...
        {expenses.length === 0 ? (
          ...
          <ul className="space-y-2 text-sm">
            {expenses.map((e, i) => (
              <li key={`${e.description}-${i}`} className="flex items-start justify-between gap-3 rounded bg-slate-50 px-3 py-2">
                <span>
                ...
                <button
                  ...
                  aria-label={`Remove ${e.description} expense`}
